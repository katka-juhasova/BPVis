...
#     # html.Div(
#     #     children=[
#     #         luacode_left.view(dash_id='input-luacode', columns='4'),
#     #         seesoft_left.view(dash_id='input-seesoft', columns='2',
...
# #         if (clickData) {
# #             var element = document.getElementById("input-luacode");
# #             var element_text_id = "input-luacode" + clickData.points[0].text;
...
fig.add_trace(go.Scatter(x=random_x, y=random_y4,
                         marker={'color': '#eaeaea'},
                         mode='markers',
                         name='comments and other omitted sections'))
